...
# script is from https://github.com/peteanderson80/Matterport3DSimulator/blob/master/tasks/R2R/data/download.sh
# if this script failed, checkout the above link
